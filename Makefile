...
check_PROGRAMS = test-alignment$(EXEEXT) test-rules$(EXEEXT) \
...
am__EXEEXT_1 = test-exception$(EXEEXT)
...
test_exception_DEPENDENCIES = libyara/.libs/libyara.a
...
yarac_DEPENDENCIES = libyara/.libs/libyara.a
AM_V_P = $(am__v_P_$(V))
...
am__v_CCLD_1 = 
SOURCES = $(test_alignment_SOURCES) $(test_elf_SOURCES) \
	$(test_exception_SOURCES) $(test_pe_SOURCES) \
	$(test_rules_SOURCES) $(test_version_SOURCES) $(yara_SOURCES) \
	$(yarac_SOURCES)
DIST_SOURCES = $(test_alignment_SOURCES) $(test_elf_SOURCES) \
	$(test_exception_SOURCES) $(test_pe_SOURCES) \
	$(test_rules_SOURCES) $(test_version_SOURCES) $(yara_SOURCES) \
	$(yarac_SOURCES)
...
TEST_LOG_COMPILE = $(TEST_LOG_COMPILER) $(AM_TEST_LOG_FLAGS) \
	$(TEST_LOG_FLAGS)
am__DIST_COMMON = $(srcdir)/Makefile.in AUTHORS COPYING ar-lib compile \
...
ACLOCAL = ${SHELL} /Users/yotti/sec/yara/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AR = ar
AUTOCONF = ${SHELL} /Users/yotti/sec/yara/missing autoconf
AUTOHEADER = ${SHELL} /Users/yotti/sec/yara/missing autoheader
AUTOMAKE = ${SHELL} /Users/yotti/sec/yara/missing automake-1.15
AWK = awk
CC = gcc
CCDEPMODE = depmode=gcc3
CFLAGS =  -I/opt/local/include -I/usr/local/opt/openssl/include -D_THREAD_SAFE  -DHASH_MODULE
CPP = gcc -E
CPPFLAGS = 
CYGPATH_W = echo
DEFS = -DPACKAGE_NAME=\"yara\" -DPACKAGE_TARNAME=\"yara\" -DPACKAGE_VERSION=\"3.6.3\" -DPACKAGE_STRING=\"yara\ 3.6.3\" -DPACKAGE_BUGREPORT=\"vmalvarez@virustotal.com\" -DPACKAGE_URL=\"\" -DPACKAGE=\"yara\" -DVERSION=\"3.6.3\" -DYYTEXT_POINTER=1 -DSTDC_HEADERS=1 -DHAVE_SYS_TYPES_H=1 -DHAVE_SYS_STAT_H=1 -DHAVE_STDLIB_H=1 -DHAVE_STRING_H=1 -DHAVE_MEMORY_H=1 -DHAVE_STRINGS_H=1 -DHAVE_INTTYPES_H=1 -DHAVE_STDINT_H=1 -DHAVE_UNISTD_H=1 -DHAVE_DLFCN_H=1 -DLT_OBJDIR=\".libs/\" -DHAVE_LIBM=1 -DHAVE_LIBM=1 -DHAVE_STRLCPY=1 -DHAVE_STRLCAT=1 -DHAVE_MEMMEM=1 -DHAVE_TIMEGM=1 -DHAVE_OPENSSL_MD5_H=1 -DHAVE_OPENSSL_SHA_H=1 -DHAVE_OPENSSL_ASN1_H=1 -DHAVE_OPENSSL_CRYPTO_H=1 -DHAVE_OPENSSL_BIO_H=1 -DHAVE_OPENSSL_PKCS7_H=1 -DHAVE_OPENSSL_X509_H=1 -DHAVE_OPENSSL_SAFESTACK_H=1 -DHAVE_LIBCRYPTO=1 -DHAVE_LIBCRYPTO=1 -DHAVE_LIBCRYPTO=1 -DHAVE_LIBCRYPTO=1 -DHAVE_LIBCRYPTO=1 -DHAVE_LIBCRYPTO=1
DEPDIR = .deps
DLLTOOL = false
DSYMUTIL = dsymutil
DUMPBIN = 
...
LTLIBOBJS = 
LT_SYS_LIBRARY_PATH = 
MAKEINFO = ${SHELL} /Users/yotti/sec/yara/missing makeinfo
MANIFEST_TOOL = :
...
YACC = bison -y
YFLAGS = 
abs_builddir = /Users/yotti/sec/yara
abs_srcdir = /Users/yotti/sec/yara
abs_top_builddir = /Users/yotti/sec/yara
abs_top_srcdir = /Users/yotti/sec/yara
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
acx_pthread_config = 
...
install_sh = ${SHELL} /Users/yotti/sec/yara/install-sh
...
include ./$(DEPDIR)/yarac.Po
include tests/$(DEPDIR)/test-alignment.Po
include tests/$(DEPDIR)/test-elf.Po
include tests/$(DEPDIR)/test-exception.Po
include tests/$(DEPDIR)/test-pe.Po
include tests/$(DEPDIR)/test-rules.Po
include tests/$(DEPDIR)/test-version.Po
